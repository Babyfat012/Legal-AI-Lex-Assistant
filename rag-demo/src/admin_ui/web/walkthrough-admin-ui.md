# Admin UI Rebuild — Walkthrough

## Tổng quan

Rebuild Admin UI từ **Streamlit** sang **React + Vite SPA** với thiết kế premium dark glassmorphism theme, phù hợp cho demo MVP.

## Changes Made

### Backend (1 file modified)

#### [routes.py](file:///home/phattl/code/fsds_final_proj/aide4/Legal-AI-Lex-Assistant/rag-demo/src/api/routes.py)
- Thêm import `get_db` và `Session`
- Thêm endpoint `GET /api/v1/ingest/logs` — trả về lịch sử ingest từ PostgreSQL
...
Toàn bộ nằm trong `src/admin_ui/web/`:

| File | Vai trò |
|---|---|
| [index.html](file:///home/phattl/code/fsds_final_proj/aide4/Legal-AI-Lex-Assistant/rag-demo/src/admin_ui/web/index.html) | Entry HTML, Inter font, meta SEO |
| [index.css](file:///home/phattl/code/fsds_final_proj/aide4/Legal-AI-Lex-Assistant/rag-demo/src/admin_ui/web/src/index.css) | Design system — 18KB CSS tokens, animations, component styles |
| [main.jsx](file:///home/phattl/code/fsds_final_proj/aide4/Legal-AI-Lex-Assistant/rag-demo/src/admin_ui/web/src/main.jsx) | React entry point |
| [App.jsx](file:///home/phattl/code/fsds_final_proj/aide4/Legal-AI-Lex-Assistant/rag-demo/src/admin_ui/web/src/App.jsx) | Auth guard + Router + Toaster |
| [client.js](file:///home/phattl/code/fsds_final_proj/aide4/Legal-AI-Lex-Assistant/rag-demo/src/admin_ui/web/src/api/client.js) | Axios API client (5 functions) |
| [LoginPage.jsx](file:///home/phattl/code/fsds_final_proj/aide4/Legal-AI-Lex-Assistant/rag-demo/src/admin_ui/web/src/components/Auth/LoginPage.jsx) | Login form + password toggle |
| [Sidebar.jsx](file:///home/phattl/code/fsds_final_proj/aide4/Legal-AI-Lex-Assistant/rag-demo/src/admin_ui/web/src/components/Layout/Sidebar.jsx) | Nav sidebar + active state + logout |
| [UploadPage.jsx](file:///home/phattl/code/fsds_final_proj/aide4/Legal-AI-Lex-Assistant/rag-demo/src/admin_ui/web/src/pages/UploadPage.jsx) | Drag-drop upload + progress bars |
| [DocumentsPage.jsx](file:///home/phattl/code/fsds_final_proj/aide4/Legal-AI-Lex-Assistant/rag-demo/src/admin_ui/web/src/pages/DocumentsPage.jsx) | Data table + search + delete modal |
| [CollectionPage.jsx](file:///home/phattl/code/fsds_final_proj/aide4/Legal-AI-Lex-Assistant/rag-demo/src/admin_ui/web/src/pages/CollectionPage.jsx) | Stat cards + health bar + JSON viewer |
...
### Login Page
![Login — Glassmorphism card, dark theme, ⚖️ icon](/home/phattl/.gemini/antigravity/brain/506dfdc7-39a2-44cc-871c-35be34693d67/admin_ui_login_page_1776567596799.png)

### Upload Page
![Upload — Sidebar nav, drag-drop zone, file list](/home/phattl/.gemini/antigravity/brain/506dfdc7-39a2-44cc-871c-35be34693d67/lex_admin_upload_page_1776567760792.png)

### Documents Page
![Documents — Search bar, empty state, refresh button](/home/phattl/.gemini/antigravity/brain/506dfdc7-39a2-44cc-871c-35be34693d67/lex_admin_documents_page_1776567778964.png)

### Collection Stats Page
![Collection — Empty state (backend offline), Qdrant info](/home/phattl/.gemini/antigravity/brain/506dfdc7-39a2-44cc-871c-35be34693d67/lex_admin_collection_page_1776567800860.png)
...
```bash
cd rag-demo/src/admin_ui/web
npm run dev
```

Mở `http://localhost:5173` → Login bằng `admin123`

> [!NOTE]
> Đảm bảo FastAPI backend đang chạy ở `http://localhost:8000` để các API calls hoạt động.

## Verified

- ✅ `npm run build` — 0 errors, bundle 368KB gzipped 118KB
- ✅ `npm run dev` — dev server ok ở port 5173
- ✅ Login flow: nhập password → redirect vào dashboard
- ✅ 3 pages sidebar navigation hoạt động
- ✅ Dark theme consistent, không flash of white
- ✅ Empty states hiển thị đúng (Documents, Collection khi backend offline)
